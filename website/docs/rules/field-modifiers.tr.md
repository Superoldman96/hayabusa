...
## Hayabusa tarafından desteklenmeyen alan niteleyicileri
Şu anda her şey destekleniyor.

## Hayabusa tarafından desteklenen korelasyon kuralları
| Korelasyon Kuralı                 |   Sigma Sayısı |   Hayabusa Sayısı |
|:---------------------------------|--------------:|-----------------:|
| event_count                      |             0 |                0 |

# معدّلات الحقول المدعومة

تحتوي هذه الصفحة على قائمة مُنشأة ديناميكيًا بجميع معدّلات حقول Sigma ومدى تكرار استخدامها في قواعد Sigma وHayabusa.

## معدّلات الحقول المدعومة في Hayabusa
...
## معدّلات الحقول غير المدعومة في Hayabusa
حاليًا، كل شيء مدعوم.

## قواعد الارتباط المدعومة في Hayabusa
...
## قواعد الارتباط غير المدعومة في Hayabusa
حاليًا، كل شيء مدعوم.

يجري تحديث هذا المستند ديناميكيًا شهريًا بناءً على أحدث القواعد.  
